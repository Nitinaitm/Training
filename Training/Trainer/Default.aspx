...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .grid-card { background: #fff; border-radius: 10px; box-shadow: 0 0 8px #d9d9d9; padding: 20px; }
        ...
        <div class="main-card">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="summary-card">
                        <div class="summary-value"><asp:Label ID="lblTodaySession" runat="server" Text="0" /></div>
                        <div class="summary-label">Today's Sessions</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="summary-card">
                        <div class="summary-value"><asp:Label ID="lblPendingAttendance" runat="server" Text="0" /></div>
                        <div class="summary-label">Pending Attendance</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="summary-card">
                        <div class="summary-value"><asp:Label ID="lblPendingPreTest" runat="server" Text="0" /></div>
                        <div class="summary-label">Pending Pre Test</div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="summary-card">
                        <div class="summary-value"><asp:Label ID="lblPendingPostTest" runat="server" Text="0" /></div>
                        <div class="summary-label">Pending Post Test</div>
                    </div>
                </div>
            </div>
            ...
            <div class="search-card">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label>Batch</label>
                        <asp:DropDownList ID="ddlBatch" runat="server" CssClass="form-select" />
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <label>&nbsp;</label><br />
                        <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="btn btn-success btn-search" OnClick="btnSearch_Click" />
                        <asp:Button ID="btnReset" runat="server" Text="Reset" CssClass="btn btn-secondary btn-search" OnClick="btnReset_Click" />
                    </div>
                </div>
            </div>
                ...
                <asp:GridView ID="gvSession" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover gridview" Width="100%" EmptyDataText="No Session Assigned" ShowHeaderWhenEmpty="true" DataKeyNames="SessionID,TrainingID" OnRowCommand="gvSession_RowCommand" OnRowDataBound="gvSession_RowDataBound">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Workflow">
                            <ItemTemplate>
                                <asp:Label ID="lblWorkflow" runat="server" Text='<%# Eval("WorkflowStatus") %>' CssClass="badge bg-secondary" />
                            </ItemTemplate>
                            <ItemStyle Width="130px" HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Attendance">
                            <ItemTemplate>
                                <asp:Label ID="lblAttendance" runat="server" Text='<%# Eval("AttendanceStatus") %>' CssClass="badge bg-danger" />
                            </ItemTemplate>
                            <ItemStyle Width="110px" HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:Button ID="btnView" runat="server" Text="View" CssClass="btn btn-primary btn-sm" CommandName="View" CommandArgument='<%# Eval("SessionID") %>' />
                            </ItemTemplate>
