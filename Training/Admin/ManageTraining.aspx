...
<asp:Button ID="btnRequirements" runat="server" Text="Training Requirements / Skip" CssClass="btn btn-danger btn-action" OnClick="btnRequirements_Click" />
