...
<asp:Button ID="btnRequirements" runat="server" Text="Training Requirements / Skip" CssClass="btn btn-danger btn-action" Visible="false" OnClick="btnRequirements_Click" />
...
<asp:Button ID="btnCompleteTraining" runat="server" Text="Mark Complete Training" CssClass="btn btn-success btn-action" Visible="true" OnClick="btnCompleteTraining_Click" />
</div>
