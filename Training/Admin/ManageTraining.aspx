...
<asp:Button ID="btnRequirements" runat="server" Text="Training Requirements / Skip" CssClass="btn btn-danger btn-action" PostBackUrl="TrainingRequirements.aspx" CausesValidation="false" />
