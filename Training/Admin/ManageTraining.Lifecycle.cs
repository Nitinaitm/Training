...
namespace Training.Admin
{
    public partial class ManageTraining
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (completed)
            {
                btnUpdateTraining.Visible = false; btnAssignSession.Visible = false; btnAssignTrainee.Visible = false;
                btnRequirements.Visible = false; btnAssignFeedback.Visible = false; btnAssignHostel.Visible = false;
                btnCertificateTemplate.Visible = false; btnStartTraining.Visible = false; btnAttendance.Visible = true;
            }
            else
            {
                ...
                {
                    btnCertificateTemplate.Visible = false; btnCertificateTemplate.Enabled = false;
                    btnStartTraining.Enabled = false; btnRequirements.Visible = true;
                }
            }
