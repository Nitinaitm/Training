        ...
        new SqlParameter(
            ...
            )
            {
                ScriptManager.RegisterStartupScript(
                    ...
                    GetType(),
                    "msg",
                    "alert('Pre Training Test is not available for this session.');window.location='MySessions.aspx';",
                    true);
    ...
    EventArgs e)
        ...
        new SqlParameter(
            ...
            ScriptManager.RegisterStartupScript(
                ...
                GetType(),
                "msg",
                "alert('Pre Training Examination submitted successfully.');window.location='MySessions.aspx';",
                true);
        }
        ...
        new SqlParameter(
            ...
            )
            {
                sql =
                    ...
                    "SET TrainingStatus='Pre Exam Completed'," +
                    "WorkflowStatus='G'," +
                    "UpdatedOn=GETDATE()," +
                    "UpdatedBy=@UpdatedBy " +
                    "WHERE TrainingID=@TrainingID";
