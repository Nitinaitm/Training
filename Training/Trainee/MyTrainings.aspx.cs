...
namespace Training.Trainee
{
    public partial class MyTrainings : System.Web.UI.Page
    {
        ...
        protected void gvTraining_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            LinkButton f = (LinkButton)e.Row.FindControl("lnkFeedback");
            LinkButton c = (LinkButton)e.Row.FindControl("lnkCertificate");
            LinkButton a = (LinkButton)e.Row.FindControl("lnkAttendance");
